...
public class SpecFeatureController {
	...
	public ModelAndView add(Feature  feature , FeatureVo vo  ) {
		...
		boolean flag = false;
		try {
			//temp = featureBiz.add(feature,vo.getValueList());
		...
		return new ModelAndView("redirect:/specFeature/list");
	}
	...
	public ModelAndView edit(Feature feature,FeatureVo vo) {
		boolean flag=false;
		try {
			//int result = featureBiz.edit(feature,vo.getValueList());
			//if (result == 1) {
				 flag=true;
			//}
		} catch (Exception e) {
