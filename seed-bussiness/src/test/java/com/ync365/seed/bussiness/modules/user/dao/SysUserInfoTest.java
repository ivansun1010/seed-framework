...
public class SysUserInfoTest {
	...
	public void testInsertSelective() {
		...
		userInfo.setSysUserAddress("sssssss");
	...
	public void testDeleteByPrimaryKey() {
		int amount = infoMapper.deleteByPrimaryKey(USER_NUM);
		assertEquals(1, amount);
	}
	
	@Test
	public void testSelectByPrimaryKey() {
		SysUserInfo userInfo = infoMapper.selectByPrimaryKey(USER_NUM);
	...
	public void testUpdateByPrimaryKeySelective () {
		SysUserInfo userInfo = new SysUserInfo();
		userInfo.setSysUserAddress("ssssasdfsss");
		userInfo.setSysUserAddressDetail("dddsaf");
		userInfo.setSysUserBirthday(new Date());
		userInfo.setSysUserFarmArea(1);
		userInfo.setSysUserGender(1);
		userInfo.setSysUserIdCard("1d");
		userInfo.setSysUserName("testd");
